...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")
    ...
    Case "CD0340": txtCampus = "코어 광주"  '광주
                campusName = "core_gj"
                campusName02 = "cont_gj"
                txt_01 = "1차. 2/5(월), 2차. 3/1(금)"

    Case "CD0341": txtCampus = "코어 대전"  '대전
                campusName = "core_dj"
                campusName02 = "cont_dj"

    Case "CD0343": txtCampus = "코어 원주"  '원주
                campusName = "core_wj"
                campusName02 = "cont_wj"

    Case "CD0344": txtCampus = "코어 전주"  '전주
                campusName = "core_jj"
                campusName02 = "cont_jj"

    Case "CD0345": txtCampus = "코어 창원"  '창원
                campusName = "core_cw"
                campusName02 = "cont_cw"

    Case "CD0346": txtCampus = "코어 청주"  '청주
                campusName = "core_cj"
...
<div class="visual-wrap">
    ...
    <div class="visual">
        ...
        <p><strong>최상위권이 집결하는 <%=txtCampus%></strong>에서 경쟁하는 것이<br>
            <strong>대입성공의 경쟁력</strong>입니다.</p>
        <div class="info-box">
            <dl>
                <dt><%=tit_01%></dt>
                <dd><%=txt_01%></dd>
