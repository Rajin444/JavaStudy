...
<section class="sub-wrap">
    ...
    <div class="regular-wrap">
        ...
        <div class="container <%=campusName%>">
            ...
            <!-- tab -->
            <!-- #include virtual = "/intro/2024/regular/tab01.asp" -->
            <!-- #include virtual = "/intro/2024/regular/tab02.asp" -->
            ...
            <% End If %>
            <p><a href="<%=pc_url%>/intro/2024/regular/index.asp" target="_blank" class="bt-pc">PC페이지로 이동</a></p>
        </div>
    </div>
</section>
