...
<div class="cont04 js-cont">
    <div class="inner">
        ...
        <div class="rbox">
            ...
            <ul class="list-check">
                <% If campus_code = "CD0340" Then '코어광주 %>
                <li>메가스터디 온&middot;오프 수능 전문 강사진의 몰입감 높은 현장 강의와 대치동 LIVE 강의</li>
                <% Else %>
        ...
        <div class="rbox">
            ...
            <a href="javascript:void(0)" onclick="javascript:alert('추후 오픈 예정입니다.');" >바로가기</a>
        </div>
    </div>
</div>
                    ...
                    <div class="swiper-slide">
                        <div class="s-wrap">
                            ...
                            <div class="s-slide swiper-container type01">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <% If campus_code = "CD0244" OR campus_code = "CD0340" Then '분당/코어광주 %>
                        ...
                        <div class="s-wrap">
                            ...
                            <div class="s-slide swiper-container type02">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <% If campus_code = "CD0244" OR campus_code = "CD0248"  OR campus_code = "CD0340" Then '분당/평촌/센텀/코어광주 %>
                                    ...
                                    <div class="swiper-slide">
                                        <% If campus_code = "CD0244" OR campus_code = "CD0248" OR campus_code = "CD0246" Then '분당/평촌/센텀 %>
                    ...
                    <div class="swiper-slide">
                        <div class="s-wrap">
                            ...
                            <div class="s-slide swiper-container type03">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <% If campus_code = "CD0244" OR campus_code = "CD0248" OR campus_code = "CD0340" Then '분당/평촌/코어광주 %>
                                    ...
                                    <div class="swiper-slide">
                                        <% If campus_code = "CD0247" OR campus_code = "CD0244" OR campus_code = "CD0248" OR campus_code = "CD0340" Then '강남/분당/평촌/코어광주 %>
    ...
    <div class="inner">
        ...
        <div class="rbox">
            ...
            <ul class="list-dot">
                ...
                <li>모의고사, 평가원 성적과 학습 태도 점수를 바탕으로 <strong>연 3회 승반&middot;강반 평가 진행<br>
                    3~4월, 5~6월, 7~8월 합산</strong>하여 평가 (2023년 기준)</li>
                <% Else %>
            ...
            <p class="r-txt mt10">※ 반편성 및 장학혜택은 추후 공지예정입니다.</p>
            <% End If %>

            <div class="grade-swiper swiper-container">
                <% If campus_code = "INTRO" OR campus_code = "CD0244" Then '인트로/분당 %>
                <div class="swiper-wrapper">
        ...
        <div class="contbox">
            <div class="program-slide-navi swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">메가X대성<br>THE PREMIUM 모의고사</div>
